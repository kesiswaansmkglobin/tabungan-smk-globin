  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">Data Sekolah</h1>
          <p className="text-muted-foreground">Kelola informasi sekolah dan pengelola tabungan</p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="border-t pt-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">Informasi Pengelola Tabungan</h3>
          ...
          <div className="border-t pt-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">Logo Sekolah</h3>
